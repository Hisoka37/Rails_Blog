...
RSpec.describe 'User page', type: :system do
  describe 'User index' do
    before(:each) do
      @user1 = User.create!(name: 'Zena', photo: 'https://unsplash.com/photos/F_-0BxGuVvo',
                            bio: 'Teacher from Morocco.', posts_counter: 0)
      @user2 = User.create!(name: 'John', photo: 'https://unsplash.com/photos/zedf', bio: 'Engineer from Canada.',
                            posts_counter: 0)
